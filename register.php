...
<div id="container-user-akses">
    ...
    <?php
        ...
        if($notif == "require"){
            echo "<div class='notif'> Maaf, anda harus melengkapi form di bawah ini </div>";
        }else if($notif == "password"){
            echo "<div class='password'> Maaf, Password yang anda masukkan tidak sama </div>";
        }else if($notif == "email"){
            echo "<div class='email'> Maaf, Email yang anda masukkan sudah terdaftar </div>";
        }
    ?>
